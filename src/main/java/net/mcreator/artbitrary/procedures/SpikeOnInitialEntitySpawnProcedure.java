...
public class SpikeOnInitialEntitySpawnProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if (entity instanceof SpikeEntity) {
			((SpikeEntity) entity).setAnimation("animation.model.spawn");
		}
