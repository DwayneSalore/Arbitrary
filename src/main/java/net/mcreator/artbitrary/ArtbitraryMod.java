package net.mcreator.artbitrary;
...
@Mod("artbitrary")
public class ArtbitraryMod {
	public static final Logger LOGGER = LogManager.getLogger(ArtbitraryMod.class);
	public static final String MODID = "artbitrary";

	public ArtbitraryMod() {
