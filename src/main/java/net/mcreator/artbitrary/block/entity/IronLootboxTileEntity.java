package net.mcreator.artbitrary.block.entity;
...
public class IronLootboxTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public IronLootboxTileEntity(BlockPos pos, BlockState state) {
		super(ArtbitraryModBlockEntities.IRON_LOOTBOX.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(IronLootboxBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<IronLootboxTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<IronLootboxTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("iron_lootbox");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Iron Lootbox");
	}
